...
//           <div className="btn2">
//             <a href="#" className="btn2 btn2-button enhanced-btn">
//               Sign in with SSO
//             </a>
//           </div>
//         </div>
...
export default function LoginPage() {
  ...
  const loginType = searchParams.get("type") || "staff";
  ...
  const handleSubmit = (e) => {
    ...
    // Assign login role
    const role = loginType === "admin" ? "admin" : "staff";
    localStorage.setItem("userRole", role);
    localStorage.setItem("authToken", "demo-token");
    localStorage.setItem(
      "user",
      JSON.stringify({ email, name: name || "User" })
    );
  ...
  return (
    <div className="login-wrapper">
      <div className="login-card">
        ...
        <h2 className="title">{showLogin ? "Login" : "Create Account"}</h2>
